...
tmux send-keys -t tig "SELECTED_ALGORITHMS='{\"vehicle_routing\":\"clarke_wright_super\"}'" C-m
tmux send-keys -t tig "./target/release/tig-benchmarker \$ACCOUNT \$API \$SELECTED_ALGORITHMS --workers \$WORKERS --master \$MASTER_IP" C-m
